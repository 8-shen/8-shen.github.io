    ...
    */
    ...
    r.prototype.init = function (e) {
      ...
      try {
        ...
        v.params = "?d=" + (i.indexOf(o) > -1 ? o : "mp") + "&v=1.3.1" + c, v.hide = "hide" === o, v.cdn = !!l && l || v.cdn, b = e.path || b;
        ...
        t.alert = {
          show: function (e) {
            ...
            if (n.innerHTML = "" + r + (e && e.type && i), d.on("click", d.find(L, ".vcancel"), function (e) {
                t.alert.hide()
              }), d.attr(L, "style", "display:block;"), e && e.type) {
              var o = d.find(L, ".vsure");
          ...
          hide: function () {
            return d.attr(L, "style", "display:none;"), t
          }
        }, t.bind(e)
      } catch (e) {
        t.ErrorHandler(e)
    ...
    r.prototype.Q = function (e) {
      ...
      t.emoji = {
        ...
        show: function () {
          return t.emoji.hide(), d.attr(p, "v", 1), d.removeAttr(i, "v"), r.innerHTML = f.comment, d.attr(r, "style", "display:block"), T(), t.preview
        },
        hide: function () {
      ...
      var x = function (e) {
          ...
          var n = d.findAll(t, "*"),
            r = ["INPUT", "SCRIPT", "IFRAME", "FRAME", "AUDIO", "VIDEO", "EMBED"],
            i = function (e, t) {
              var n = d.attr(e, t);
        ...
        M = function n() {
          ...
          a.limit(i), a.skip((r - 1) * i), a.find().then(function (e) {
            for (var a = e.length, s = [], l = 0; l < a; l++) {
              var c = e[l];
              s.push(c.id), L(c, d.find(t.el, ".vlist"), !0)
            }
      ...
      var j = function () {
        ...
        U = d.find(t.el, ".vsubmit"),
        P = function (e) {
          if (d.attr(U, "disabled")) return void t.alert.show({
            type: 0,
        ...
        Q = function () {
          d.attr(U, "disabled", !0), t.loading.show(!0);
          ...
          for (var i in f)
            ...
            try {
              if (R.rid) {
                ...
                L(e, i, !0)
              } else n ? (r = Number(n.innerText) + 1, n.innerText = r) : d.find(t.el, ".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments, L(e, d.find(t.el, ".vlist"));
              f.mail && V({
                username: f.nick,
                mail: f.mail
              }), R.at && R.rmail && t.notify && N({
                username: R.at.replace("@", ""),
                mail: R.rmail
              }), d.removeAttr(U, "disabled"), t.loading.hide(), j()
            } catch (e) {
              t.ErrorHandler(e)
            }
          }).catch(function (e) {
      ...
      d.on("click", U, P), d.on("keydown", document, function (e) {
        e = event || e;
